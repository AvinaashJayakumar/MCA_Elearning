...
<div class="login-box animate__animated animate__fadeInUp" style="animation-delay: 0.2s;">
  ...
  <!--<div class="card card-outline card-primary">-->
    <div class="card-header text-center">
                <img src="MCAlogo.jpeg" alt="" style="height:80px; width:85px;  border-radius:50px;"><h4 style="color:lightblue;font-weight:bold;">MCA E_LEARNING</h4>
                <a href="./" class="h2" style="color:lightblue;"><b>Student Login</b></a><br>
     
<a href="Register.php" style="font-size:22px;"> Register</a>
			
    </div>
    <div class="card-body">
      <p class="login-box-msg" style="color:lightblue;">Sign in to start your session</p>

      <form id="slogin-frm" action="" method="post">
