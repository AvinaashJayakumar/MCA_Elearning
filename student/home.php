<h1 style="text-align: center; font-size: 24px;">
  Welcome to <span style="color: rgb(136, 119, 18); font-weight: bold;"><?php echo $_settings->info('name') ?></span>
</h1>
<hr>
<br>
<center>
  <h2>To Know about more technologies, click the below button</h2>
</center>
<center>
  <button type="submit" style="background-color: #007BFF; color: #FFFFFF; font-size: 18px; padding: 12px 24px; border: none; border-radius: 5px; cursor: pointer;">
    <a href="home.html" style="text-decoration: none; color: #FFFFFF;">Search here</a>
  </button>
</center>
