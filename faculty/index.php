  ...
  <?php endif; ?>
    <div class="wrapper">
     ...
     <?php $page = isset($_GET['page']) ? $_GET['page'] : 'home';  ?>
      ...
      <div class="content-wrapper" style="min-height: 567.854px;background-image: url('https://banner2.cleanpng.com/20180526/yzr/kisspng-computer-science-desktop-wallpaper-programmer-clip-5b094e2c933588.719990101527336492603.jpg');background-repeat:no-repeat;background-size:1200px 640px;">
