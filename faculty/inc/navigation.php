              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-2">
                   <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>faculty/?page=class" class="nav-link nav-class">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>faculty/?page=lesson" class="nav-link nav-lesson">
                        <i class="nav-icon fas fa-list"></i>
                        <p>
                          Lessons
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>faculty/?page=file_uploads" class="nav-link nav-file_uploads">
