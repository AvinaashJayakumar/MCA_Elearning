  ...
  <body class="layout-fixed layout-footer-fixed text-sm sidebar-mini control-sidebar-slide-open layout-navbar-fixed " data-new-gr-c-s-check-loaded="14.991.0" data-gr-ext-installed="" style="height: auto;">
    <div class="wrapper">
     ...
     <?php $page = isset($_GET['page']) ? $_GET['page'] : 'home';  ?>
      ...
      <div class="content-wrapper" style="min-height: 567.854px;background-image: url('https://www.vhv.rs/dpng/d/312-3121420_computer-science-engineering-cartoon-hd-png-download.png');background-repeat: no-repeat; background-size: 1200px 640px;">
